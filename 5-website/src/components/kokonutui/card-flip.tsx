    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="absolute end-0 bottom-0 start-0 p-5">
          ...
          <div className="mt-6 border-zinc-200 border-t pt-6 dark:border-zinc-800">
            ...
            >
              ...
              <div className="group/icon relative">
                ...
                <ArrowRight
                  aria-hidden="true"
                  className="relative z-10 h-4 w-4 text-orange-500 transition-transform duration-300 group-hover/start:translate-x-0.5 rtl:group-hover/start:-translate-x-0.5 group-hover/start:scale-110"
                />
              </div>
            </button>
          </div>
